...
export function buildDevPreviewCommentRows(episodes: Episode[]): DevPreviewCommentRow[] {
  ...
  return compactRows([
    ...
    row(
      ...
      '9',
      '이다은',
      '@배한솔 액팅 a001은 피드백 1차 기준으로 손 위치만 다시 확인하면 될 것 같습니다.',
      ['배한솔'],
    ...
    row(
      ...
      '6',
      '박정인',
      '리비전 쪽 확인 댓글입니다. 리비전 댓글 알림 테스트에서 이 id를 사용합니다.',
      [],
  ...
  return [
    {
      ...
      status: 'in_progress',
      priority: 'normal',
      description: '[테스트] 리비전 댓글 알림이 이 카드로 이동합니다. 카드 안 댓글 스레드에서 새 댓글 강조를 확인하세요.',
      frameNo: '',
      imageUrl: '',
      department: 'bg',
      requesterId: '5',
    ...
    },
    {
      ...
      status: 'resolved',
      priority: 'normal',
      description: '[테스트] 라이트 모드 댓글창에서 완료 리비전 문구 대비를 확인하는 샘플입니다.',
      frameNo: '',
      imageUrl: '',
      department: 'bg',
      requesterId: '8',
