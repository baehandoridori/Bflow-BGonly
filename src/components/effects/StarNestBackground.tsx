...
export function StarNestBackground({
  ...
  useEffect(() => {
    ...
    const locs = Object.fromEntries(
      ['uRes', 'uTime', 'uSpeed', 'uZoom', 'uBrightness', 'uSaturation', 'uDarkmatter', 'uDistfading', 'uAngleX', 'uAngleY', 'uVolsteps', 'uIterations', 'uColorShift', 'uSparkle', 'uSparkleSpeed', 'uOffset']
