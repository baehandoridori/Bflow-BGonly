  ...
  return {
    ...
    games: {
      ...
      '2048': {
        ...
        maxLevel: 0,
        leaderboardAll: [
          { userId: 'preview-minji', name: '민지', score: 6_420, at: SEED_AT },
          { userId: 'preview-doyun', name: '도윤', score: 4_820, at: SEED_AT },
          { userId: 'preview-seoa', name: '서아', score: 3_152, at: SEED_AT },
        ],
        leaderboardWeekly: [
          { userId: 'preview-minji', name: '민지', score: 4_304, at: SEED_AT },
          { userId: 'preview-doyun', name: '도윤', score: 3_152, at: SEED_AT },
        ],
      },
    },
