...
> **2026-04-22 업데이트**: Pro 플랜으로 전환되어 아래 무료 플랜 제약 사항은 더 이상 적용되지 않음.
> 특히 **7일 미사용 시 자동 일시정지** 항목은 해소되었으며, keep-alive 대응 불필요.
> 아래 내용은 마이그레이션 당시 계획 맥락 보존 목적으로 남겨둠.
...
| 프로젝트 일시정지 | ~~**7일 미사용 시**~~ | 매일 사용 | ~~**주의: 긴 연휴 시 정지될 수 있음**~~ → Pro 전환(2026-04-22)으로 해소 |

> ~~**중요**: 무료 플랜은 7일간 API 요청이 없으면 프로젝트가 자동 일시정지됨.
> 대응: 간단한 keep-alive 요청을 주기적으로 보내거나, 연휴 전에 수동으로 앱을 한 번 실행.~~
> → Pro 플랜 전환(2026-04-22)으로 자동 정지 제약 해소됨. keep-alive 대응 불필요.
