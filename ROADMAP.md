...
### 2026-09-14 팀 할 일 · 캐릭터 현황판 바로 열기 (v1.118.0, 피드백 58·59) `[운영 DB 적용 완료, 머지·배포 대기]`
...
- [x] 로컬 멀티 에이전트 리뷰(최신 댓글 가림 수정)·뮤테이션 테스트 보강(생존 40종 → 48종 전부 감지), 코덱스 리뷰 루프 반영
...
- [ ] 머지·정식 빌드·공유 드라이브 배포(manifest 마지막 갱신)
