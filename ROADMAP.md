...
- [ ] **앱 릴리스**: 실제 Electron·공유 계정·Realtime 인수 검사와 설치본 배포.
...
- [ ] **간트·캘린더 상황별 인수 검증** (진행): 설치본 업데이트, 작업 편집·일정 양방향 연동·권한·실패 복구·동시 편집을 검증하고 발견한 문제는 로컬 리뷰 후 재배포. `DEVLOG/2026-09-06-gantt-calendar-scenarios.md` 참조.
