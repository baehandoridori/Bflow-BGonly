...
> **최종 갱신**: 2026-02-20 (Phase 2 완료, Phase 6 아이디어 추가)
...
| 16 | 위젯 레이아웃 편집 (iPhone wiggle) | P6 | ●●● | 대시보드 커스터마이징 |
| 17 | AOT 플로팅 위젯 (글래스 효과) | P6 | ●●● | 바탕화면 현황 위젯 |
| 18 | 진행률 동기부여 메시지 | P6 | ●○○ | 재미 요소 |
| 19 | 전체 UI 통일성 & 폴리시 | P6 | ●●○ | 시각적 완성도 |
| 20 | 스포트라이트 검색 (Ctrl+Space) | P6 | ●●● | 빠른 네비게이션 |
...
├── components/
│   └── spotlight/
│       └── SpotlightSearch.tsx  ← P6 스포트라이트 검색
├── services/
...
│   └── useWidgetStore.ts     ← P6 위젯 레이아웃/AOT 상태
├── types/
