...
> **최종 갱신**: 2026-02-27 (Phase 8-0~8-1 완료 반영)
> **프로젝트**: Bflow (Studio JBBJ 프로덕션 진행 현황 대시보드)
> **담당**: Claude × 한솔 (Studio JBBJ)
> **현재 상태**: Phase 0 (0-4 제외) 완료, Phase 1~2 완료, Phase 4-1~4-3 완료, Phase 6 Step 1~4 완료, Phase 7 완료, Phase 8-0~8-1 완료
...
Phase 8: 설정 개인화            ██░░░░░░░░ 8-0~8-1 완료 ✅ (8-2~8-6 대기)
```
...
### 8-3. 플렉서스 애니메이션 제어 `P8` `[ ]`

> 난이도: ●○○ | 상태: 대기

- [ ] **AnimationSection.tsx**: 토글 (로그인/대시보드) + 파티클 수 슬라이더
- [ ] **useAppStore 연동**: plexusSettings 상태 추가
- [ ] **LoginScreen/Dashboard 연동**: 하드코딩 상수 → store에서 읽기

### 8-4. 스플래시 건너뛰기 `P8` `[ ]`

> 난이도: ●○○ | 상태: 대기

- [ ] **SplashSection.tsx**: 로딩 스플래시 / 랜딩 스플래시 개별 토글
...
> Phase 1~2 완료, Phase 6 Step 1~4 완료, Phase 7-1~7-5 완료, Phase 8-0~8-1 완료.
...
| 11 | 키보드 단축키 커스텀 | P8 | ●●○ | 8-2 대기 |
| 12 | 플렉서스 애니메이션 제어 | P8 | ●○○ | 8-3 대기 |
| 13 | 스플래시 건너뛰기 | P8 | ●○○ | 8-4 대기 |
| 14 | 로그인 자동저장 | P8 | ●○○ | 8-5 대기 |
