...
> **최종 갱신**: 2026-02-26 (Phase 0-1~0-3 완료 반영, 로드맵 전면 점검)
...
```
Phase 0: 긴급 안정화           ██████░░░░ 0-1~0-3 완료 ✅ (0-5, 0-6 대기)
Phase 1: 핵심 씬 관리         ██████████ 완료 ✅
Phase 2: 이미지 리뷰           ██████████ 완료 ✅
...
Phase 7: 대시보드 UX 혁신      ████████░░ 7-1~7-5 완료 ✅ (7-2 AOT 위치저장 대기)
```
...
- [ ] **재시도 중 UI 표시**: 토스트로 "동기화 재시도 중..." 표시 (미구현, 콘솔 로그만 출력)
...
> **2026-02-26 기준**: Phase 0-1~0-3 완료. 나머지 안정화 + 미완료 기능 진행.
...
| 3 | 0-3. 재시도 로직 | gasFetchWithRetry() 지수 백오프 | ●○○ | ✅ 완료 (UI 토스트 미구현) |
| 4 | 0-4. 테스트 모드 제거 | 코드 간소화 (선택적) | ●●○ | 검토 중 |
| **5** | **0-5. 종료 시 배치 큐 보장** | **before-quit 훅 + 미완료 큐 처리** | **●●○** | **🔜 다음** |
| **6** | **0-6. 위젯 팝업 위치 저장** | **앱 재시작 시 위젯 위치/크기/AOT 복원** | **●●○** | **🔜 다음** |
