...
> **최종 갱신**: 2026-07-13 (v1.82.0 — JBBJ 모의투자 v3 실사용 피드백 반영)
...
### 2026-09-09 서버 전용 새 로그인 `[배포 완료, 사용자 PC 확인 대기]`
...
- [x] 독립 리뷰·PR #281 병합·v1.117.4 정식 설치 파일 배포 — 필수 3파일 및 변경 122파일 SHA-256 일치, 전체 7,333파일 목록·크기 확인
- [x] 미변경 보조파일 포함 전체 원격 7,333파일 SHA-256 최종 검사 — 불일치 0, 기존 여분 파일 218개 보존
